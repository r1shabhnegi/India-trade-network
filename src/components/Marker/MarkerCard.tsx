...
const MarkerHoverCard: FC<Props> = React.memo(
  ({ port, clickedPort, setIsModal, setModalPortData }) => {
    ...
    return (
      ...
      bg-white p-2 pb-1 rounded-lg sm:w-40 md:w-52 xl:w-60 left-[50%] -translate-x-[50%] shadow-2xl z-[1000]`}>
        <a
          ...
          <p className='text-center text-[1rem] font-[600] text-gray-600 my-1'>
            {port?.name}
          </p>
